#!/usr/bin/env python3
"""
Script para comparar BER teórica vs BER simulada para QPSK.
...
from src.visualizacao.teoria_comparacao.plot_bpsk_qpsk import plotar_teorico_vs_simulado_qpsk

if __name__ == "__main__":
    print("\n" + "="*70)
    print("QPSK: BER TEÓRICA vs BER SIMULADA (CANAL RAYLEIGH)")
    print("="*70)
    print("\nEste script compara:")
    ...
    # Gera o gráfico
    fig, ax = plotar_teorico_vs_simulado_qpsk(
