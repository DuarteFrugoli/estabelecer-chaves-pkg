...
\begin{abstract}
This work presents the implementation and analysis of a complete mobile communication system aimed at physical-layer cryptographic key generation for next-generation wireless communications. The proposed approach exploits intrinsic physical properties of the wireless channel, such as reciprocity, fading, and noise, to enable the generation of identical symmetric keys between legitimate devices, eliminating the need for prior secret exchange and reducing reliance on public key infrastructures. The system integrates digital modulation, a \textit{code-offset} reconciliation protocol based on error-correcting codes, as well as a privacy amplification stage. The analysis focuses on the key disagreement rate between the cryptographic keys generated at the communicating devices as a function of fundamental system parameters, including the signal-to-noise ratio, operating frequency, and fading characteristics, in order to identify the most favorable scenarios for efficient symmetric key reconciliation. The results indicate that the system is applicable to both 5G/6G mobile networks — including low-power Internet of Things scenarios —, providing physical-layer security with low computational complexity compared to conventional cryptographic methods.
\end{abstract}
